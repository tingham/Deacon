...
var Action = /** @class */ (function () {
    ...
    Action.prototype.Coalesce = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                if (this.ControllerPath && this.MethodPath && this.Identity) {
                    return [2 /*return*/, "/".concat(this.ControllerPath, "/").concat(this.MethodPath, "/").concat(this.Identity)];
                }
                // If the controller and method are defined, we can produce a url.
                if (this.ControllerPath && this.MethodPath) {
                    return [2 /*return*/, "/".concat(this.ControllerPath, "/").concat(this.MethodPath)];
                }
                // If only controller or method are defined, and the identity is defined, we can produce a url.
                if (this.Identity) {
                    if (this.ControllerPath) {
                        return [2 /*return*/, "/".concat(this.ControllerPath, "/").concat(this.Identity)];
                    }
                    if (this.MethodPath) {
                        return [2 /*return*/, "/".concat(this.MethodPath, "/").concat(this.Identity)];
                    }
                }
                // If only the identity is defined we cannot produce a url and need to throw an error because this is a misconfiguration
                throw new ImprintIdentityOrphaned("An ImprintAction cannot have an identity (".concat(this.Identity, ") without a controller or method."));
            });
        });
    };
    return Action;
